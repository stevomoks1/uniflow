...
<body>
    <div class="layout">
        ...
        <div class="page">
            ...
            <div class="content">
                <h1 class="page-title">Edit Previous Requirements</h1>
                <p class="page-description">Choose a previously submitted requirement and update details.</p>
                <div class="card">
                    <table>
                        <thead>
                            <tr><th>Course Code</th><th>Lecturer</th><th>Students</th><th>Status</th><th>Action</th></tr>
                        </thead>
                        <tbody>
                            <% for (WorkflowDAO.RequirementRecord req : requirements) { %>
