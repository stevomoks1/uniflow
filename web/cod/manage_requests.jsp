...
<body>
    <div class="layout">
        ...
        <div class="page">
            ...
            <div class="content">
                <h1 class="page-title">Requirement Pipeline Status</h1>
                <p class="page-description">Flow step 2 onward: track consolidation, draft release, adjustments, and finalization.</p>
                <div class="card">
                    <table>
                        <thead>
