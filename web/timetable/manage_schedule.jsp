            ...
            <div class="content">
                <div class="card">
                    ...
                    <div class="actions">
                        ...
                        <a class="button" href="<%= request.getContextPath() %>/timetable/draft_timetable_week2.jsp">Week 2 draft</a>
                        <a class="button" href="<%= request.getContextPath() %>/timetable/final_timetable.jsp">Final timetable</a>
                    </div>
