...
<body>
    <div class="page">
        ...
        <div class="nav">
            ...
            <a class="btn" href="<%= request.getContextPath() %>/timetable/draft_timetable_week2.jsp">Print week 2 draft</a>
            <a class="btn" href="<%= request.getContextPath() %>/timetable/final_timetable.jsp">Print final timetable</a>
