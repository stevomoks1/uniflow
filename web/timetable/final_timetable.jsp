...
<body>
    ...
    <div class="page">
        <div class="no-print">
            <h1>Final Timetable</h1>
            <p>Printable final timetable for all finalized requirements.</p>
            <button class="btn" type="button" onclick="window.print()">Print final timetable</button>
        </div>
        <div class="card">
            <table>
                <thead>
