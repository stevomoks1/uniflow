            ...
            <div class="content">
                <div class="card">
                    ...
                    <div class="actions">
                        ...
                        <a class="button" href="<%= request.getContextPath() %>/requirement/draft_requirements_week2.jsp">Week 2 draft</a>
                        <a class="button" href="<%= request.getContextPath() %>/requirement/final_rquirements.jsp">Final requirements</a>
                    </div>
