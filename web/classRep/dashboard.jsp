    ...
    <div class="layout">
        ...
        <div class="panel grid">
            <div class="card">
                ...
                <p>Submit facility, overcrowding, or equipment issues immediately.</p>
            </div>
            <div class="card">
                <h3>Status Tracking</h3>
                <p>Track the progress of issues and see how they are being resolved.</p>
            </div>
            <div class="card">
                <h3>Analytics</h3>
                <p>View counts and trends for reported issues.</p>
            </div>
        </div>
