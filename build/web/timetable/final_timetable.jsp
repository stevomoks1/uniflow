        ...
        <div class="page">
            ...
            <div class="content">
                <div class="card no-print">
                    <h1 class="page-title">Final Timetable</h1>
                    <p class="page-description">Generate final timetable for all finalized requirements.</p>
                    <div class="actions">
                        <a class="button" href="<%= request.getContextPath() %>/timetable/dashboard.jsp">Back to dashboard</a>
                        <button class="button primary" type="button" onclick="window.print()">Generate final timetable</button>
                    </div>
                </div>
                <div class="card">
                    <table>
